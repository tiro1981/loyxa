...
(function () {
    ...
    const I18N = {
        uz: {
            ...
            'hero.title_2':            'ishonchli tarzda',
            'hero.title_online':       'online',
            'hero.title_3':            'ga aylantiring',
            'hero.title_sub':          'Bepul',
            'hero.subtitle':           'Do\'kon, fast food va kafe uchun korporativ darajadagi veb-ilova va boshqaruv paneli. Xavfsiz, tez va 24/7 qo\'llab-quvvatlash bilan.',
            ...
            'apps.subtitle':           'Har bir soha uchun maxsus sozlangan, tayyor ishga tushiriladigan yechimlar.',
            'how.tag':                 'QANDAY ISHLAYDI',
            'how.title':               '3 qadamda ishga tushiring',
            'how.subtitle':            '5 daqiqada biznesingizni online ga olib chiqing',
            'reviews.tag':             'MIJOZLAR',
            'reviews.title':           '200+ biznes egasi tanladi',
            'reviews.subtitle':        'Mijozlarimiz platformadan qanday foydalanmoqda',
            // CTA / Footer
            'cta.title':               'Bugun boshlang — bepul',
        ...
        ru: {
            ...
            'hero.title_1':            'Переведите бизнес',
            'hero.title_2':            'в',
            'hero.title_online':       'онлайн',
            'hero.title_3':            '— надёжно',
            'hero.title_sub':          'Бесплатно',
            'hero.subtitle':           'Веб-приложение и панель управления корпоративного уровня для магазина, фастфуда и кафе. Безопасно, быстро и с поддержкой 24/7.',
            ...
            'apps.subtitle':           'Готовые к запуску решения, настроенные под каждую сферу.',
            'how.tag':                 'КАК ЭТО РАБОТАЕТ',
            'how.title':               'Запуск за 3 шага',
            'how.subtitle':            'Запустите бизнес онлайн за 5 минут',
            'reviews.tag':             'КЛИЕНТЫ',
            'reviews.title':           'Нас выбрали 200+ владельцев бизнеса',
            'reviews.subtitle':        'Как наши клиенты используют платформу',
            'cta.title':               'Начните сегодня — бесплатно',
        ...
        en: {
            ...
            'hero.title_1':            'Turn your',
            'hero.title_2':            'business',
            'hero.title_online':       'online',
            'hero.title_3':            '— reliably',
            'hero.title_sub':          'Free',
            'hero.subtitle':           'Enterprise-grade web app and dashboard for shops, fast food and cafes. Secure, fast and backed by 24/7 support.',
            ...
            'apps.subtitle':           'Ready-to-launch solutions tailored for every industry.',
            'how.tag':                 'HOW IT WORKS',
            'how.title':               'Launch in 3 steps',
            'how.subtitle':            'Take your business online in 5 minutes',
            'reviews.tag':             'CLIENTS',
            'reviews.title':           '200+ business owners chose us',
            'reviews.subtitle':        'How our clients use the platform',
