    ...
    async init(app, client) {
      ...
      try {
        ...
        if (res && res.__timeout) {
          ...
          // mirror bo'lmaydi — server 2.5s dan sekin javob bersa (masalan sekin mobil tarmoq),
          // oldingi versiya bu javobni butunlay tashlab yuborar edi va do'kon doim bo'sh
          // ko'rinardi. Endi kech kelgan javobni ham qo'llab, "cloud:updated" orqali UI'ni
          // qayta chizamiz.
