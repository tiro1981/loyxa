...
/* ---------- Default Demo Data ---------- */
/* Kitob muqovasi — o'zicha yetarli SVG gradient (internet shart emas).
   Dizayndagidek: yuqorida muallif, pastda kitob nomi (2 qatorgacha). */
...
const DEFAULT_DATA = {
    products: [
        ...
        { id: 2, name: "Sarob", author: "Abdulla Qahhor", category: "badiiy", price: 38000, image: bookCover("Sarob", "Abdulla Qahhor", "#e11d48", "#f97316"), desc: "Ijtimoiy-psixologik roman insonning ichki kurashi, orzu va haqiqat o'rtasidagi ziddiyatni mahorat bilan ochib beradi.", pages: 912, rating: 4.5, stock: 25, sold: 736, active: true },
        ...
        { id: 4, name: "Shum bola", author: "G'afur G'ulom", category: "bolalar", price: 29000, image: bookCover("Shum bola", "G'afur G'ulom", "#0f766e", "#14b8a6"), desc: "Sho'x va topqir bola boshidan kechirgan qiziqarli sarguzashtlar. Bolalar va kattalar sevib o'qiydigan asar.", pages: 176, rating: 4.7, stock: 50, sold: 615, active: true },
        { id: 5, name: "Kecha va kunduz", author: "Cho'lpon", category: "badiiy", price: 41000, image: bookCover("Kecha va kunduz", "Cho'lpon", "#0c4a4a", "#0e7490"), desc: "Zebi obrazida o'zbek ayolining fojiali taqdiri, mustamlaka davri jamiyati ochib berilgan mumtoz roman.", pages: 288, rating: 4.8, stock: 18, sold: 588, active: true },
        { id: 6, name: "Mehrobdan chayon", author: "Abdulla Qodiriy", category: "tarix", price: 43000, image: bookCover("Mehrobdan chayon", "Abdulla Qodiriy", "#b45309", "#f59e0b"), desc: "Xon saroyi kotibi Anvar hayoti orqali o'rta asr saroy hayoti, mehr-muhabbat va xiyonat tasvirlangan roman.", pages: 320, rating: 4.6, stock: 22, sold: 421, active: true },
        { id: 7, name: "Navoiy", author: "Oybek", category: "tarix", price: 47000, image: bookCover("Navoiy", "Oybek", "#1e3a8a", "#3b82f6"), desc: "Buyuk shoir va davlat arbobi Alisher Navoiy hayoti va ijodiga bag'ishlangan tarixiy roman.", pages: 480, rating: 4.7, stock: 27, sold: 356, active: true },
        { id: 8, name: "Sinchalak", author: "Abdulla Qahhor", category: "badiiy", price: 33000, image: bookCover("Sinchalak", "Abdulla Qahhor", "#831843", "#db2777"), desc: "Qishloq hayoti, mehnat va inson xarakterlari haqidagi qissa. Sodda tilda chuqur ma'no.", pages: 208, rating: 4.4, stock: 35, sold: 298, active: true },
    ],
    ...
    categories: [
        { id: 'badiiy', name: "Badiiy", icon: "📖", desc: "Roman, qissa va hikoyalar", active: true },
        { id: 'ilmiy', name: "Ilmiy", icon: "🔬", desc: "Ilmiy va ilmiy-ommabop kitoblar", active: true },
        { id: 'tarix', name: "Tarix", icon: "🏛️", desc: "Tarixiy asarlar va tadqiqotlar", active: true },
        { id: 'bolalar', name: "Bolalar", icon: "🧸", desc: "Bolalar uchun kitoblar", active: true },
        { id: 'sheriyat', name: "She'riyat", icon: "🖋️", desc: "She'r va dostonlar", active: true },
        { id: 'biznes', name: "Biznes", icon: "💼", desc: "Biznes va shaxsiy rivojlanish", active: true },
    ],
...
// Umumiy manba: uzbekistan-regions.js (window.UZ_REGIONS — 14 viloyat, 203 tuman).
// Bu fayl boot-loader'da script.js'dan OLDIN yuklanadi, shu sabab global tayyor turadi.
// Eski (kichikroq) inline ro'yxat olib tashlandi — endi barcha ilovalar bitta manbadan foydalanadi.
        ...
        fetch(`${BOT_HTTP}/store-bot/order`, {
            ...
            .then(res => {
                if (res && res.ok) {
                    ...
                    localStorage.setItem('kitob_bot_config', JSON.stringify(cfg));
                } else {
...
if (document.querySelector('.app .screen[data-screen="home"]')) {
    ...
    const NOTIF_KEY = 'kitob_notif_seen';
    ...
    // Bookz — standart qorong'u mavzu (faqat foydalanuvchi yoritilganni tanlasa '0')
    ...
    function productCard(p) {
        ...
        return `
            <div class="p-card" data-pid="${p.id}">
                ...
                <div class="p-body">
                    <div class="p-cat">${escapeHtml(p.author || p.category)}</div>
                    <div class="p-name">${escapeHtml(p.name)}</div>
                    ${p.rating ? `<div class="p-rating">★ ${p.rating}</div>` : ''}
                    <div class="p-row">
                        <div class="p-prices">
    ...
    function openProductDetail(id) {
        ...
        document.getElementById('productDetail').innerHTML = `
            <div class="sheet-body">
                ...
                <div class="pd-cat">${escapeHtml((data.categories.find(c => c.id === p.category) || {}).name || p.category)}</div>
    ...
    /* ============ CHAT (user ↔ admin) ============ */
    const CHAT_USER_KEY = 'kitob_chat_user';
